...
namespace Dev.Ioc.ServiceLocator
{
    /// <summary>
    ...
    public abstract class ServiceLocatorImplBase : IServiceLocator, IServiceProvider
    {
        ...
        /// 
        /// </summary>
        /// <param name="serviceType">The requested service.</param><exception cref="T:Microsoft.Practices.ServiceLocation.ActivationException">if there is an error in resolving the service instance.</exception>
        /// <returns>
        ...
        public virtual IEnumerable<TService> GetAllInstances<TService>()
        {
            ...
            try
            {
                IEnumerator<object> enumerator = this.GetAllInstances(typeof(TService)).GetEnumerator();
        ...
        /// 
        /// </summary>
        /// <param name="actualException">The actual exception thrown by the implementation.</param><param name="serviceType">Type of service requested.</param><param name="key">Name requested.</param>
        /// <returns>
        ...
        /// 
        /// </summary>
        /// <param name="actualException">The actual exception thrown by the implementation.</param><param name="serviceType">Type of service requested.</param>
        /// <returns>
        /// The formatted exception message string.
        /// </returns>
        protected virtual string FormatActivateAllExceptionMessage(Exception actualException, Type serviceType)
        {
            return string.Format((IFormatProvider)CultureInfo.CurrentUICulture, "{0}", new object[1]
            {
                (object) serviceType.Name
            });
        }
