...
namespace Dev.Ioc.Container
{
    ...
    public abstract class ContainerImplBase : IContainer
    {
        ...
        public void RegisterWithConstructor(Type service, Type implementation, params Parameter[] parameter)
        {
            RegisterWithConstructor(service, implementation, null, parameter);
        }
        public void RegisterWithConstructor<TService, TImplementation>(string named, params Parameter[] parameter) where TImplementation : TService
        {
            RegisterWithConstructor(typeof(TService), typeof(TImplementation), named, parameter);
        }

        public abstract void RegisterWithConstructor(Type service, Type implementation, string named,
