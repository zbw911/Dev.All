...
namespace Dev.Ioc.Container
{
    ...
    public interface IContainer
    {
        ...
        void RegisterWithConstructor<TService, TImplementation>(params Parameter[] parameter) where TImplementation : TService;

        void RegisterWithConstructor(Type service, Type implementation, params Parameter[] parameter);


        void RegisterWithConstructor<TService, TImplementation>(string named, params Parameter[] parameter) where TImplementation : TService;

        void RegisterWithConstructor(Type service, Type implementation, string named, params Parameter[] parameter);
        /// <summary>
