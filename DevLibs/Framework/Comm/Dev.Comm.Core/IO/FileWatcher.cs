...
namespace Dev.Comm.IO
{
    ...
    public class FileWatcher
    {
        ...
        private static readonly Dictionary<string, FileSystemWatcher> WatchList = new Dictionary<string, FileSystemWatcher>();
    ...
    /// 存放在内存中的方式
    /// </summary>
    class MemFileWatchStorage : IFileWatchStorage
    {
