...
namespace DS.Web.UCenter
{
    ...
    public static class UcConfig
    {
        ...
        private static IDictionary<string, string> Items
        {
        ...
        public static string UcApi
        {
            get
            {
                string str = getStringValue("UC_API", checkEmpty: true);
        ...
        {
            get { return getStringValue("UC_CHARSET", checkEmpty: true); }
        }
        ...
        {
            get { return getStringValue("UC_IP"); }
        }
        ...
        private static string getValueTemp(string key)
        {
            ...
            if (!Items.ContainsKey(key)) Items.Add(key, GetValue(key));
            return Items[key];
        }

        /// <summary>
        /// added by zbw911 for the uc.config
        /// </summary>
        /// <param name="key"></param>
        /// <returns></returns>
        private static string GetValue(string key)
        {
            string configfile = "uc.config";
