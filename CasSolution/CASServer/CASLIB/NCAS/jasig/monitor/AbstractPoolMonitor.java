 ...
 * @since 3.5.0
 */
public abstract class AbstractPoolMonitor : AbstractNamedMonitor<PoolStatus> {

    /** Default maximum wait time for asynchronous pool validation. */
    public static  int DEFAULT_MAX_WAIT = 3000;
    ...
    public PoolStatus observe() {
         Future<StatusCode> result = this.executor.submit(new Validator());
        StatusCode code;
