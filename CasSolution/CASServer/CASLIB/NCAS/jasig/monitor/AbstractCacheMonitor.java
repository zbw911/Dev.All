 ...
 * @since 3.5.1
 */
public abstract class AbstractCacheMonitor : AbstractNamedMonitor<CacheStatus> {

    /** Default free capacity threshold is 10%. */
    public static  int DEFAULT_WARN_FREE_THRESHOLD = 10;

    /** Default eviction threshold is 0. */
    public static  long DEFAULT_EVICTION_THRESHOLD = 0;
