...
public abstract class AbstractDistributedTicketRegistry : AbstractTicketRegistry {
    ...
    private static class TicketDelegator<T : Ticket> : Ticket {
    ...
    private static  class ServiceTicketDelegator : TicketDelegator<ServiceTicket> : ServiceTicket {
    ...
    private static  class TicketGrantingTicketDelegator : TicketDelegator<TicketGrantingTicket> : TicketGrantingTicket {
