 ...
 *
 */
public class JpaLockingStrategy : LockingStrategy {
    ...
    @Transactional(readOnly = false)
    public void release() {
         Lock lock = entityManager.find(Lock.class, applicationId, LockModeType.PESSIMISTIC_WRITE);
    ...
    public string getOwner() {
         Lock lock = entityManager.find(Lock.class, applicationId);
        if (lock != null) {
    ...
    private bool acquire( EntityManager em, Lock lock) {
