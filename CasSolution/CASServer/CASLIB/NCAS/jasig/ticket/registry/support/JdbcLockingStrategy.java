...
public class JdbcLockingStrategy
     ...
     */
    public void setApplicationIdColumnName( string name) {
     ...
     */
    public void setUniqueIdColumnName( string name) {
     ...
     */
    public void setExpirationDateColumnName( string name) {
    ...
    public bool acquire() {
        ...
        try {
	         SqlRowSet rowSet = (SqlRowSet) this.jdbcTemplate.query(
	            this.selectSql,
	            new Object[] {this.applicationId},
	            new SqlRowSetResultSetExtractor());
	         Timestamp expDate = getExpirationDate();
	        if (!rowSet.next()) {
     ...
     */
    private bool canAcquire( SqlRowSet lockRow) {
