...
public class JaasAuthenticationHandler :
    ...
    protected  bool authenticateUsernamePasswordInternal(
        ...
        try {
            if (log.isDebugEnabled()) {
             ...
             LoginContext lc = new LoginContext(this.realm,
     ...
     */
    protected static  class UsernamePasswordCallbackHandler : CallbackHandler {
         ...
         */
        protected UsernamePasswordCallbackHandler( string userName,
             string password) {
