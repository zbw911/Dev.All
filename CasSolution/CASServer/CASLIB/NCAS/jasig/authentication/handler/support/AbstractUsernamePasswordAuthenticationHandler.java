...
public abstract class AbstractUsernamePasswordAuthenticationHandler :
    ...
    private static  Class<UsernamePasswordCredentials> DEFAULT_CLASS = UsernamePasswordCredentials.class;
     ...
     */
    protected  bool doAuthentication( Credentials credentials)
