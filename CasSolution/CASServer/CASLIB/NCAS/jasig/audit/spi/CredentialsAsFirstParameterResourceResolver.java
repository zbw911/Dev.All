 ...
 *
 */
public  class CredentialsAsFirstParameterResourceResolver : AuditResourceResolver {

    public string[] resolveFrom( JoinPoint joinPoint,  Object retval) {
         Credentials credentials = (Credentials) AopUtils.unWrapJoinPoint(joinPoint).getArgs()[0];
