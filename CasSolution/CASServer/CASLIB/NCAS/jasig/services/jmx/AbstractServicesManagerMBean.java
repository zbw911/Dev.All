 ...
 * @since 3.4.4
 */
public abstract class AbstractServicesManagerMBean<T : ServicesManager> {
    ...
    public  List<string> getRegisteredServicesAsStrings() {
    ...
    public  RegisteredService removeService( long id) {
