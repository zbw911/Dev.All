...
public class AuthenticationViaFormAction {
    ...
    public  void doBind( RequestContext context,  Credentials credentials) throws Exception {
    ...
    public  String submit( RequestContext context,  Credentials credentials,  MessageContext messageContext) throws Exception {
