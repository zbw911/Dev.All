 ...
 */
//public  class SafeContextLoaderListener : ServletContextListener {
...
using System;
using NCAS.jasig.web.init;
using WebActivator;

[assembly: System.Web.PreApplicationStartMethod(typeof(SafeContextLoaderListener), "contextInitialized")]
[assembly: ApplicationShutdownMethod(typeof(SafeContextLoaderListener), "contextDestroyed")]
namespace NCAS.jasig.web.init
{
    public class SafeContextLoaderListener
    {
     ...
     */
        ...
        public void contextDestroyed(/* ServletContextEvent sce*/)
        {
            //this.delegate.this.contextDestroyed(sce);
        }
