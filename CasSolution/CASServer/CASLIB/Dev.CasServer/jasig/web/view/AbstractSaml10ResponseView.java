...
public abstract class AbstractSaml10ResponseView extends AbstractCasView {
    ...
    protected void renderMergedOutputModel(
        ...
        try {
             Response samlResponse = newSamlObject(Response.class);
    ...
    protected  <T extends SAMLObject> T newSamlObject( Class<T> objectType) {
         QName qName;
        try {
    ...
    protected  Status newStatus( QName codeValue,  String statusMessage) {
         Status status = newSamlObject(Status.class);
         StatusCode code = newSamlObject(StatusCode.class);
        code.setValue(codeValue);
        status.setStatusCode(code);
        if (statusMessage != null) {
             StatusMessage message = newSamlObject(StatusMessage.class);
