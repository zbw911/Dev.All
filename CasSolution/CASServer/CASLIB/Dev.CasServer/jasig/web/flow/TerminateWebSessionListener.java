 ...
 * @since 3.5.1
 */
public  class TerminateWebSessionListener extends FlowExecutionListenerAdapter {
    ...
    public void sessionStarted( RequestContext context,  FlowSession session) {
        ...
        if (service != null && service.getId().startsWith(serviceManagerUrl)) {
             HttpSession webSession = WebUtils.getHttpServletRequest(context).getSession(false);
            if (webSession != null) {
