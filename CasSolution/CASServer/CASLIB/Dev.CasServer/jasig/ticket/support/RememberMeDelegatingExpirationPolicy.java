 ...
 *
 */
public  class RememberMeDelegatingExpirationPolicy implements ExpirationPolicy {
    ...
    public boolean isExpired(TicketState ticketState) {
         Boolean b = (Boolean) ticketState.getAuthentication().getAttributes().get(RememberMeCredentials.AUTHENTICATION_ATTRIBUTE_REMEMBER_ME);
