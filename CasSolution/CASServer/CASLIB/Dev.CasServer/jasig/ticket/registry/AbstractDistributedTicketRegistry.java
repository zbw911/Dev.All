...
public abstract class AbstractDistributedTicketRegistry extends AbstractTicketRegistry {
    ...
    private static  class ServiceTicketDelegator extends TicketDelegator<ServiceTicket> implements ServiceTicket {
        ...
        public boolean isValidFor( Service service) {
             boolean b = this.getTicket().isValidFor(service);
            updateTicket();
            return b;
        }
    ...
    private static  class TicketGrantingTicketDelegator extends TicketDelegator<TicketGrantingTicket> implements TicketGrantingTicket {
